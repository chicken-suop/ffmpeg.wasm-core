...
if [[ "$FFMPEG_ST" != "yes" ]]; then
  ...
  EXTRA_FLAGS=(
    ...
    -o wasm/packages/core/dist/ffmpeg-core.js
		-s INITIAL_MEMORY=1073741824                  # 1024MB (must be less than 2048MB)
  )
else
  ...
  EXTRA_FLAGS=(
    -o wasm/packages/core-st/dist/ffmpeg-core.js
		...
		-s MAXIMUM_MEMORY=4294967296                 # 4096MB
		-s ALLOW_MEMORY_GROWTH=1
  )
fi
FLAGS=(
  -I. -I./fftools -I$BUILD_DIR/include
  -Llibavcodec -Llibavdevice -Llibavfilter -Llibavformat -Llibavresample -Llibavutil -Llib -Llibswscale -Llibswresample -Llibfdk-aac -L$BUILD_DIR/lib
  ...
  -lavdevice -lavfilter -lavformat -lavcodec -lswresample -lswscale -lavutil -lm -lx264 -lfdk-aac -lz
